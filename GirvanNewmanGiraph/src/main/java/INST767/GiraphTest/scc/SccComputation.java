...
package INST767.GiraphTest.scc;




import static INST767.GiraphTest.scc.SccPhaseMasterCompute.CONVERGED;
import static INST767.GiraphTest.scc.SccPhaseMasterCompute.NEW_MAXIMUM;
import static INST767.GiraphTest.scc.SccPhaseMasterCompute.PHASE;
import INST767.GiraphTest.scc.SccPhaseMasterCompute;
import INST767.GiraphTest.scc.SccPhaseMasterCompute.Phases;
...
public class SccComputation extends
   ...
   */
  private final LongWritable messageValue = new LongWritable();

  /**
   * Reusable object to encapsulate a parent vertex id.
   */
  private final LongWritable parentId = new LongWritable();
